...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Actualización para src/app/api/send-email/route.ts
// Busca la sección del htmlContent y reemplázala con esto:
  ...
  htmlContent = `
    ...
    <head>
      ...
      <style>
        ...
        /* ✨ NUEVO: Estilos para info de seña */
        .sena-box {
          background: #fef3c7;
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="info-box">
            ...
            <div class="info-row">
              <span class="label">📱 Tu contacto:</span>
          ...
          <div class="sena-box">
            ...
            <div class="payment-methods">
              ...
              <ul>
                ...
                <li><strong>Efectivo:</strong> En la barbería (presentate antes del turno)</li>
              </ul>
            </div>
            
            <p style="color: #92400e; margin-top: 15px; font-size: 0.95rem;">
              <strong>📱 Importante:</strong> Una vez realizado el pago, envianos el comprobante por WhatsApp para confirmar definitivamente tu turno.
            </p>
          </div>
          
          <!-- Price Total -->
          <div class="price-highlight">
            Total del servicio: $${datos.precio.toLocaleString()}
          </div>
          ...
          <div class="important-box">
            ...
            <ul>
              ...
              <li>Si no recibimos la seña, el turno puede ser reasignado a otro cliente.</li>
              <li><strong>Llegá 5 minutos antes</strong> de tu horario programado.</li>
              <li>Para <strong>cancelar o reprogramar</strong>, avisanos con al menos <strong>24 horas de anticipación</strong>.</li>
              <li>El saldo restante se abona en efectivo o transferencia al finalizar el servicio.</li>
            </ul>
          </div>
          ...
          <div style="text-align: center;">
            <a href="https://wa.me/5493489594230?text=Hola,%20realicé%20el%20pago%20de%20la%20seña%20para%20mi%20turno%20del%20${encodeURIComponent(datos.fecha)}%20a%20las%20${datos.hora}.%20Adjunto%20comprobante." class="button">
              💬 Enviar comprobante por WhatsApp
            </a>
          </div>
          
          <p style="margin-top: 30px; font-size: 0.95rem; color: #64748b;">
            ¿Tenés alguna duda sobre el pago o tu turno? No dudes en responder este email o escribirnos por WhatsApp. Estamos para ayudarte.
          </p>
